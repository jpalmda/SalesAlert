...
export const mockClients: Client[] = [
  { id: "c1", smartpos_id: "SP001", name: "Padaria Estrela", type: "b2b_empresa", last_purchase_date: "2026-03-10T10:00:00Z", is_vip: true, tags: ["frequente", "volume alto"], created_at: "2026-01-01T00:00:00Z" },
  { id: "c2", smartpos_id: "SP002", name: "Maria Silva", type: "b2c_fisica", last_purchase_date: "2026-02-15T10:00:00Z", is_vip: false, tags: ["inativo"], created_at: "2026-01-01T00:00:00Z" },
  { id: "c3", smartpos_id: "SP003", name: "Restaurante Sabor", type: "b2b_empresa", last_purchase_date: "2026-04-01T10:00:00Z", is_vip: true, tags: ["frequente"], created_at: "2026-01-01T00:00:00Z" },
  { id: "c4", smartpos_id: "SP004", name: "João Santos", type: "b2c_fisica", last_purchase_date: "2026-01-20T10:00:00Z", is_vip: false, tags: ["inativo", "reativar"], created_at: "2026-01-01T00:00:00Z" },
  { id: "c5", smartpos_id: "SP005", name: "Café Central", type: "b2b_empresa", last_purchase_date: "2026-03-28T10:00:00Z", is_vip: false, tags: [], created_at: "2026-01-01T00:00:00Z" },
  { id: "c6", smartpos_id: "SP006", name: "Ana Oliveira", type: "b2c_fisica", last_purchase_date: "2026-04-10T10:00:00Z", is_vip: true, tags: ["frequente"], created_at: "2026-01-01T00:00:00Z" },
];

export const mockProducts: Product[] = [
  { id: "p1", smartpos_id: "PR001", name: "Brigadeiro Gourmet", stock_quantity: 150, is_highlight_of_day: true, frequently_bought_with: ["p2", "p3"], created_at: "2026-01-01T00:00:00Z" },
  { id: "p2", smartpos_id: "PR002", name: "Beijinho", stock_quantity: 80, is_highlight_of_day: false, frequently_bought_with: ["p1"], created_at: "2026-01-01T00:00:00Z" },
  { id: "p3", smartpos_id: "PR003", name: "Trufa de Chocolate", stock_quantity: 5, is_highlight_of_day: true, frequently_bought_with: ["p1", "p4"], created_at: "2026-01-01T00:00:00Z" },
  { id: "p4", smartpos_id: "PR004", name: "Coxinha de Doce de Leite", stock_quantity: 45, is_highlight_of_day: false, frequently_bought_with: ["p3"], created_at: "2026-01-01T00:00:00Z" },
  { id: "p5", smartpos_id: "PR005", name: "Palha Italiana", stock_quantity: 3, is_highlight_of_day: false, frequently_bought_with: ["p1", "p2"], created_at: "2026-01-01T00:00:00Z" },
  { id: "p6", smartpos_id: "PR006", name: "Bolo no Pote", stock_quantity: 200, is_highlight_of_day: true, frequently_bought_with: [], created_at: "2026-01-01T00:00:00Z" },
];
